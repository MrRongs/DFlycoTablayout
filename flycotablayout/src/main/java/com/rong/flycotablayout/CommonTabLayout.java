package com.rong.flycotablayout;
...
import com.rong.flycotablayout.utils.FragmentChangeManager;
import com.rong.flycotablayout.utils.UnreadMsgUtils;
import com.rong.flycotablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private boolean mIndicatorAnimStart;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorAnimStart = ta.getBoolean(R.styleable.CommonTabLayout_tl_indicator_anim_start, false);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                if(mIndicatorAnimStart){
                    //TODO
                    if(i == mCurrentTab){
                        iv_tab_icon.setImageResource(tabEntity.getTabSelectedIcon());
                        AnimationDrawable animationDrawable = (AnimationDrawable) iv_tab_icon.getDrawable();
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setmIndicatorAnimStart(boolean indicatorAnimStart) {
        this.mIndicatorAnimStart = indicatorAnimStart;
    }
    ...
    public boolean ismIndicatorAnimStart() {
        return mIndicatorAnimStart;
    }
